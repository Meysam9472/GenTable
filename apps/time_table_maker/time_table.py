...
@router.post("/add-teacher", status_code=status.HTTP_200_OK)
...
@router.get("/get-teachers", status_code=status.HTTP_200_OK)
...
@router.delete("/delete-teacher/{id}", status_code=status.HTTP_200_OK)
...
@router.patch("/update-teacher/{id}", status_code=status.HTTP_200_OK) # Put teacher ID in the URL path
...
@router.patch("/update-course/{id}", status_code=status.HTTP_200_OK) # Put course ID in the URL path
...
@router.delete("/delete-course/{id}", status_code=status.HTTP_200_OK)
...
@router.post("/add-course", status_code=status.HTTP_200_OK)
...
@router.get("/get-relations", status_code=status.HTTP_200_OK)
...
@router.post("/add-relation", status_code=status.HTTP_200_OK)
...
@router.delete("/delete-relation/{id}", status_code=status.HTTP_200_OK)
...
@router.get("/get-all-user-schedules-list/{user_id}", status_code=status.HTTP_200_OK)
...
@router.get("/get-user-schedule/{task_id}", status_code=status.HTTP_200_OK)
...
@router.delete("/delete-user-schedule/{task_id}", status_code=status.HTTP_200_OK)
